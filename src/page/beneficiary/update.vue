                    ...
                    <el-form label-position="left" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="150px" class="demo-ruleForm" style="width: 500px">
                        ...
                        <el-form-item label="账户币种" prop="currency">
                            <el-select v-model="ruleForm.currency" placeholder="请选择">
                                <el-option label="请选择" value=""></el-option>
                                <el-option v-for="(item, index) in currencyList" :key="index" :label="item.currencyName" :value="item.id"></el-option>
                            </el-select>
                        </el-form-item>
    ...
    methods: {
        changeRegion(value) {
            ...
            if (this.ruleForm.region == '1') {
                if (this.ruleForm.swiftCode == null || this.ruleForm.swiftCode == "") {
                    this.ruleForm.swiftCode = "--------";
                }

                if (this.ruleForm.iBan == null || this.ruleForm.iBan == "") {
                    this.ruleForm.iBan = "-";
                }
                if (this.ruleForm.benfiAddr == null || this.ruleForm.benfiAddr == "") {
                    this.ruleForm.benfiAddr = "-";
                }
            } else {
                if (this.ruleForm.cardId == null || this.ruleForm.cardId == "") {
                    this.ruleForm.cardId = "-";
                }

                if (this.ruleForm.mobile == null || this.ruleForm.mobile == "") {
                    this.ruleForm.mobile = "-";
                }
        ...
        responseBenfiDetail(ret) {
            ...
            if (response == RESPONSE_CODE_ERROR_DATA) {
                ...
                //     path: '/home'
                // });
                this.ruleForm = ret.retData;
                this.ruleForm.benfiAddr = ret.retData.address;
                this.ruleForm.region = ret.retData.areaType.toString();
                this.ruleForm.nameAlias = ret.retData.bName;
                this.ruleForm.benType = ret.retData.bType.toString();
                this.ruleForm.bankCity = ret.retData.bankCity;
                this.ruleForm.bankName = ret.retData.bankName;
                this.ruleForm.bankProvince = ret.retData.bankProvince;
                this.ruleForm.cardId = ret.retData.cardNo;
                this.ruleForm.companyAcc = ret.retData.compAccount;
                this.ruleForm.accName = ret.retData.accountName;
                this.ruleForm.currency = ret.retData.currencyId;
                this.ruleForm.iBan = ret.retData.iban;
                this.ruleForm.mobile = ret.retData.mobile;
                this.ruleForm.swift = ret.retData.routeType;
                this.ruleForm.swiftCode = ret.retData.swiftCode;
                this.ruleForm.remark = ret.retData.remark;
                this.changeBenType(this.ruleForm.benType);
                this.changeRegion(this.ruleForm.region);
        ...
        requestUpdateBenfi() {
            ...
            editBenfiAccount(this.id, this.ruleForm.benType, this.ruleForm.region, swift, swiftCode, iBan, this.ruleForm.currency, this.ruleForm.nameAlias, this.ruleForm.bankName, this.ruleForm.companyAcc, this.ruleForm.accName, bankProvince, bankCity, cardId, benfiAddr, mobile, this.ruleForm.remark,
                function(ret) {
                    // console.log("success=" + data);
                    handler.responseUpdateBenfi(ret);
                });
        },

        responseUpdateBenfi(ret) {
            this.fullscreenLoading = false;
            ...
            if (response == RESPONSE_CODE_ERROR_DATA) {
                ...
                this.showNoticeDialog('提示', '修改受益人信息成功');
                return;
            }
        },
