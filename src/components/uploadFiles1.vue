            ...
            <el-col :span="6" v-for="(item, index) in selfUfiles" style="width: 275px;margin-bottom: 40px">
                <section class="el-upload">
                    <div class="input-div">
                        ...
                        <span style="height: 15px!important;color:#409EFF" @click="choiceFileInput(index)" v-if="item.fileUrl!=''">重新选择</span>
                    </div>
...
export default {
    data() {
        return {
            ...
            currencyType: 0, //增加
            baseUrll: '',
            pdfUrl:'http://od60al7id.bkt.clouddn.com/typepdf.png',
        }
    },
    created() {
    ...
    methods: {
        ...
        getFilesData() {
            ...
            console.log("ufileInfos==============");
            console.log(this.ufileInfos);
            console.log("selfUfiles==============");
            console.log(this.selfUfiles);
